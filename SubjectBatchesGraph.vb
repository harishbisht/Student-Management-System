...
Public Class SubjectBatchesGraph
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "SubjectBatchesGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubjectBatchesGraph
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubjectBatchesGraph = New SubjectBatchesGraph
        rpt.Site = Me.Site
        Return rpt
    End Function
